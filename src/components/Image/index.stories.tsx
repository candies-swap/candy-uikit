...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://candyswap.one/images/tokens/${token.address[56]}.svg`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://candyswap.one/images/tokens/${token.address[56]}.svg`;
        const secondarySrc = `https://candyswap.one/images/tokens/${tokens[randomTokenIndex].address[56]}.svg`;

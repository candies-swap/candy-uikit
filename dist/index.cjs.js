...
var Icon$1n = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 256 256" }, props),
        React__default['default'].createElement("image", { width: "256", height: "256", href: "/images/custom/logo-with-text.png" })));
};
...
var Icon$14 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 128 128" }, props),
        React__default['default'].createElement("image", { width: "128", height: "128", href: "/images/custom/token.png" })));
};
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://candyswap.one/swap?outputCurrency=0x794F13ec3b4260f4d734310bF151a0a4428ff856", target: "_blank" },
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", backgroundAlt2: "rgba(255, 255, 255, 0.7)", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#8b5b20", textDisabled: "#BDC2C4", textSubtle: "#603a70", disabled: "#E9EAEB", gradients: {
        ...
        React__default['default'].createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            ...
            React__default['default'].createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                ...
                React__default['default'].createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default['default'].createElement(Button, { as: "a", href: "https://candyswap.one/swap?outputCurrency=0x794F13ec3b4260f4d734310bF151a0a4428ff856", target: "_blank", scale: "sm", endIcon: React__default['default'].createElement(Icon$22, { color: lightColors.backgroundAlt }) }, buyCakeLabel))))));
};
